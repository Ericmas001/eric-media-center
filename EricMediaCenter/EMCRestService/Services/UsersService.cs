...
namespace EMCRestService.Services
{
    ...
    public class UsersService
    {
        ...
        //    try
        //    {
        //        Dictionary<string, object> result = Connector.SelectOneRow(myConnection, "select * from ericmas001.TUsers where username = @User", new Dictionary<string, object>() { { "User", user } });
